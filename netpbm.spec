...
Summary(pl):	Biblioteki do obs≥ugi rÛønych formatÛw graficznych
Name:		netpbm
Version:	9.23
Release:	1
License:	freeware
...
%description -l pl
Pakiet netpbm zawiera biblioteki funkcji obs≥uguj±cych rÛøne formaty
graficzne, w tym .pbm, .pgm, .pnm, .ppm.

%package devel
Summary:	Development tools for programs which will use the netpbm libraries
Summary(pl):	Biblioteka netpbm - czÍ∂Ê dla programistÛw
...
Pakiet netpbm-devel zawiera pliki nag≥Ûwkowe i dokumentacjÍ dla
programistÛw do tworzenia programÛw obs≥uguj±cych formaty graficzne
...
Summary(pl):	NarzÍdzia do konwersji plikÛw graficznych
...
oraz z formatÛw obs≥ugiwanych przez biblioteki netpbm.
